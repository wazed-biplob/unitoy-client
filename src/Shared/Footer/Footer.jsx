    ...
    <>
      <footer className="footer p-10 mt-8 bg-base-200 text-base-content">
        ...
        <div>
          ...
          <a className="link link-hover">Relocation</a>
        </div>
        <div>
          ...
          <div className="form-control w-80">
            <label>
              <span className="label-text">
                Join our community of dreamers, doers, and change-makers.
                Subscribe now to unlock a world of inspiration, knowledge, and
                exclusive perks delivered straight to your inbox.{" "}
              </span>
            </label>
